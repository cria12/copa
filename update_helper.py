...
def rebuild_data_js(base_dir, current_date):
    ...
    upcoming_schedule = [
        ...
        {"id": "20260617_ghana_panama", "date": "18/06/2026", "time": "00:00", "group": "L", "teamA": {"name": "Gana", "code": "gh"}, "teamB": {"name": "Panamá", "code": "pa"}, "venue": "Toronto Stadium (Toronto)"},
        {"id": "20260617_uzbekistan_colombia", "date": "18/06/2026", "time": "03:00", "group": "K", "teamA": {"name": "Uzbequistão", "code": "uz"}, "teamB": {"name": "Colômbia", "code": "co"}, "venue": "Mexico City Stadium (Cidade do México)"},
        {"id": "20260618_south_africa_czechia", "date": "18/06/2026", "time": "17:00", "group": "A", "teamA": {"name": "África do Sul", "code": "za"}, "teamB": {"name": "Tchéquia", "code": "cz"}, "venue": "Atlanta Stadium (Atlanta)"},
        ...
        {"id": "20260620_germany_ivorycoast", "date": "20/06/2026", "time": "21:00", "group": "E", "teamA": {"name": "Alemanha", "code": "de"}, "teamB": {"name": "Costa do Marfim", "code": "ci"}, "venue": "Houston Stadium (Houston)"},
        {"id": "20260620_curacao_ecuador", "date": "21/06/2026", "time": "01:00", "group": "E", "teamA": {"name": "Curaçao", "code": "cw"}, "teamB": {"name": "Equador", "code": "ec"}, "venue": "Atlanta Stadium (Atlanta)"},
        {"id": "20260620_netherlands_sweden", "date": "20/06/2026", "time": "18:00", "group": "F", "teamA": {"name": "Holanda", "code": "nl"}, "teamB": {"name": "Suécia", "code": "se"}, "venue": "Dallas Stadium (Dallas)"},
        {"id": "20260620_japan_tunisia", "date": "21/06/2026", "time": "05:00", "group": "F", "teamA": {"name": "Japão", "code": "jp"}, "teamB": {"name": "Tunísia", "code": "tn"}, "venue": "San Francisco Stadium (Santa Clara)"},
        {"id": "20260621_belgium_iran", "date": "21/06/2026", "time": "20:00", "group": "G", "teamA": {"name": "Bélgica", "code": "be"}, "teamB": {"name": "Irã", "code": "ir"}, "venue": "Vancouver Stadium (Vancouver)"},
        {"id": "20260621_egypt_newzealand", "date": "22/06/2026", "time": "02:00", "group": "G", "teamA": {"name": "Egito", "code": "eg"}, "teamB": {"name": "Nova Zelândia", "code": "nz"}, "venue": "Kansas City Stadium (Kansas City)"},
        {"id": "20260621_spain_saudiarabia", "date": "21/06/2026", "time": "17:00", "group": "H", "teamA": {"name": "Espanha", "code": "es"}, "teamB": {"name": "Arábia Saudita", "code": "sa"}, "venue": "Seattle Stadium (Seattle)"},
        {"id": "20260621_capeverde_uruguay", "date": "21/06/2026", "time": "23:00", "group": "H", "teamA": {"name": "Cabo Verde", "code": "cv"}, "teamB": {"name": "Uruguai", "code": "uy"}, "venue": "Boston Stadium (Boston)"},
        {"id": "20260622_france_norway", "date": "26/06/2026", "time": "20:00", "group": "I", "teamA": {"name": "França", "code": "fr"}, "teamB": {"name": "Noruega", "code": "no"}, "venue": "MetLife Stadium (New York/New Jersey)"},
        {"id": "20260622_senegal_iraq", "date": "26/06/2026", "time": "20:00", "group": "I", "teamA": {"name": "Senegal", "code": "sn"}, "teamB": {"name": "Iraque", "code": "iq"}, "venue": "Gillette Stadium (Boston)"},
        {"id": "20260622_argentina_austria", "date": "22/06/2026", "time": "18:00", "group": "J", "teamA": {"name": "Argentina", "code": "ar"}, "teamB": {"name": "Áustria", "code": "at"}, "venue": "Kansas City Stadium (Kansas City)"},
        {"id": "20260622_algeria_jordan", "date": "23/06/2026", "time": "04:00", "group": "J", "teamA": {"name": "Argélia", "code": "dz"}, "teamB": {"name": "Jordânia", "code": "jo"}, "venue": "San Francisco Stadium (Santa Clara)"},
        ...
        {"id": "20260623_drcongo_colombia", "date": "24/06/2026", "time": "03:00", "group": "K", "teamA": {"name": "RD Congo", "code": "cd"}, "teamB": {"name": "Colômbia", "code": "co"}, "venue": "Mexico City Stadium (Cidade do México)"},
        {"id": "20260623_england_ghana", "date": "23/06/2026", "time": "21:00", "group": "L", "teamA": {"name": "Inglaterra", "code": "gb-eng"}, "teamB": {"name": "Gana", "code": "gh"}, "venue": "AT&T Stadium (Arlington, TX)"},
        {"id": "20260623_croatia_panama", "date": "24/06/2026", "time": "00:00", "group": "L", "teamA": {"name": "Croácia", "code": "hr"}, "teamB": {"name": "Panamá", "code": "pa"}, "venue": "Toronto Stadium (Toronto)"},
        {"id": "20260624_czechia_mexico", "date": "25/06/2026", "time": "02:00", "group": "A", "teamA": {"name": "Tchéquia", "code": "cz"}, "teamB": {"name": "México", "code": "mx"}, "venue": "Estadio Azteca (Cidade do México)"},
        {"id": "20260624_southafrica_southkorea", "date": "25/06/2026", "time": "02:00", "group": "A", "teamA": {"name": "África do Sul", "code": "za"}, "teamB": {"name": "Coreia do Sul", "code": "kr"}, "venue": "BMO Field (Toronto)"},
        {"id": "20260624_bosnia_qatar", "date": "24/06/2026", "time": "20:00", "group": "B", "teamA": {"name": "Bósnia e Herzegovina", "code": "ba"}, "teamB": {"name": "Catar", "code": "qa"}, "venue": "BC Place (Vancouver)"},
        {"id": "20260624_switzerland_canada", "date": "24/06/2026", "time": "20:00", "group": "B", "teamA": {"name": "Suíça", "code": "ch"}, "teamB": {"name": "Canadá", "code": "ca"}, "venue": "Vancouver Stadium (Vancouver)"},
        {"id": "20260625_morocco_haiti", "date": "24/06/2026", "time": "23:00", "group": "C", "teamA": {"name": "Marrocos", "code": "ma"}, "teamB": {"name": "Haiti", "code": "ht"}, "venue": "Miami Stadium (Miami)"},
        {"id": "20260625_scotland_brazil", "date": "24/06/2026", "time": "23:00", "group": "C", "teamA": {"name": "Escócia", "code": "gb-sct"}, "teamB": {"name": "Brasil", "code": "br"}, "venue": "MetLife Stadium (New York/New Jersey)"},
        {"id": "20260625_turkiye_usa", "date": "26/06/2026", "time": "03:00", "group": "D", "teamA": {"name": "Turquia", "code": "tr"}, "teamB": {"name": "Estados Unidos", "code": "us"}, "venue": "SoFi Stadium (Los Angeles)"},
        {"id": "20260625_paraguay_australia", "date": "26/06/2026", "time": "03:00", "group": "D", "teamA": {"name": "Paraguai", "code": "py"}, "teamB": {"name": "Austrália", "code": "au"}, "venue": "Dallas Stadium (Dallas)"},
        {"id": "20260626_ecuador_germany", "date": "25/06/2026", "time": "21:00", "group": "E", "teamA": {"name": "Equador", "code": "ec"}, "teamB": {"name": "Alemanha", "code": "de"}, "venue": "Houston Stadium (Houston)"},
        {"id": "20260626_curacao_ivorycoast", "date": "25/06/2026", "time": "21:00", "group": "E", "teamA": {"name": "Curaçao", "code": "cw"}, "teamB": {"name": "Costa do Marfim", "code": "ci"}, "venue": "Atlanta Stadium (Atlanta)"},
        ...
        {"id": "20260626_japan_sweden", "date": "26/06/2026", "time": "00:00", "group": "F", "teamA": {"name": "Japão", "code": "jp"}, "teamB": {"name": "Suécia", "code": "se"}, "venue": "San Francisco Stadium (Santa Clara)"},
        {"id": "20260627_newzealand_belgium", "date": "27/06/2026", "time": "04:00", "group": "G", "teamA": {"name": "Nova Zelândia", "code": "nz"}, "teamB": {"name": "Bélgica", "code": "be"}, "venue": "Vancouver Stadium (Vancouver)"},
